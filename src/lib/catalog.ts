...
const fallbackHomeFlatListings: ListingCard[] = [
  createFallbackListing({
    ...
    categoryKey: "flat",
    price: 3800000,
    address: "Краснодар, квартал Шевченко, 47",
    rooms: 2,
    area: 43,
    floor: 5,
    floorsTotal: 9,
  ...
  createFallbackListing({
    ...
    categoryKey: "flat",
    price: 4200000,
    address: "Краснодар, квартал Жукова, 19",
    rooms: 2,
    area: 44,
    floor: 2,
    floorsTotal: 5,
  ...
  createFallbackListing({
    ...
    categoryKey: "flat",
    price: 4300000,
    address: "Краснодар, Ольховский квартал, 11А",
    rooms: 1,
    area: 34,
    floor: 7,
    floorsTotal: 10,
  ...
  createFallbackListing({
    ...
    categoryKey: "flat",
    price: 6100000,
    address: "Краснодар, квартал Южный, 7",
    rooms: 3,
    area: 68,
    floor: 4,
    floorsTotal: 9,
  ...
  createFallbackListing({
    ...
    categoryKey: "flat",
    price: 3450000,
    address: "Краснодар, улица Советская, 82",
    rooms: 1,
    area: 37,
    floor: 6,
    floorsTotal: 10,
  ...
  createFallbackListing({
    ...
    categoryKey: "flat",
    price: 5200000,
    address: "Краснодар, улица Оборонная, 33",
    rooms: 2,
    area: 53,
    floor: 3,
    floorsTotal: 5,
  ...
  createFallbackListing({
    ...
    categoryKey: "flat",
    price: 4700000,
    address: "Краснодар, квартал Мирный, 14",
    rooms: 2,
    area: 48,
    floor: 8,
    floorsTotal: 9,
...
const fallbackHomeCountryListings: ListingCard[] = [
  createFallbackListing({
    ...
    categoryKey: "house",
    price: 8900000,
    address: "Краснодар, посёлок Юбилейный",
    rooms: 4,
    area: 96,
    floorsTotal: 1,
    lotAreaSotka: 6.5,
  ...
  createFallbackListing({
    ...
    categoryKey: "house",
    price: 12400000,
    address: "Краснодар, посёлок Видный",
    rooms: 5,
    area: 124,
    floorsTotal: 2,
    lotAreaSotka: 8,
  ...
  createFallbackListing({
    ...
    categoryKey: "house",
    price: 6900000,
    address: "Краснодар, Каменнобродский район",
    rooms: 3,
    area: 82,
    floorsTotal: 1,
  ...
  createFallbackListing({
    ...
    categoryKey: "house",
    price: 9800000,
    address: "Краснодар, район Малая Вергунка",
    rooms: 4,
    area: 110,
    floorsTotal: 2,
    lotAreaSotka: 7.4,
  ...
  createFallbackListing({
    ...
    categoryKey: "house",
    price: 15600000,
    address: "Краснодар, посёлок Эковидный",
    rooms: 5,
    area: 138,
    floorsTotal: 2,
    lotAreaSotka: 9.1,
...
export const fallbackCatalog: CatalogSnapshot = {
  ...
  listings: [
    ...
    ...fallbackHomeCountryListings,
    {
      ...
      description:
        "Квартира в Краснодаре из базы агентства «АТЛАС». Уточните актуальные условия показа, документы и наличие по телефону.",
      h1: null,
      seoTitle: null,
      seoDescription: null,
      isFeatured: false,
    ...
    },
    {
      ...
      description:
        "Однокомнатная квартира в Краснодаре. Карточка используется как резервный объект при недоступности базы.",
      h1: null,
      seoTitle: null,
      seoDescription: null,
      isFeatured: false,
    ...
    },
    {
      ...
      description:
        "Участок в Каменнобродском районе Краснодара. Актуальные параметры и условия сделки уточняются через агентство «АТЛАС».",
      h1: null,
      seoTitle: null,
      seoDescription: null,
      isFeatured: false,

...
export default async function NewBuildingsCatalogPage({ searchParams }: { searchParams: Promise<RawCatalogSearchParams> }) {
  ...
  return <CatalogShowcase basePath={preset.path} complexes={result.docs} content={catalogPageContent} filters={filters} heroImage={heroImage} preset={preset} result={result} />
}

...
export async function generateMetadata({ searchParams }: JournalPageProps): Promise<Metadata> {
  ...
  if (hasSearch) return buildSeoMetadata({ path: "/journal", title: "Журнал агентства: как выбрать и проверить недвижимость в вашем городе", description: "Экспертные материалы агентства недвижимости о квартирах, ипотеке, земле, строительстве и новостройках в вашем городе.", noIndex: true });
  return { title: "Журнал агентства: как выбрать и проверить недвижимость в вашем городе", description: "Экспертные материалы агентства недвижимости о квартирах, ипотеке, земле, строительстве и новостройках в вашем городе.", alternates: { canonical: "/journal" }, openGraph: { title: "Журнал агентства: как выбрать и проверить недвижимость в вашем городе", description: "Экспертные материалы агентства недвижимости о квартирах, ипотеке, земле, строительстве и новостройках в вашем городе.", url: "/journal", siteName: siteConfig.clientFullName, type: "website", images: [defaultSocialPreview] }, twitter: { card: "summary_large_image", title: "Журнал агентства: как выбрать и проверить недвижимость в вашем городе", description: "Экспертные материалы агентства недвижимости о квартирах, ипотеке, земле, строительстве и новостройках в вашем городе.", images: [defaultSocialPreviewPath] } };
}

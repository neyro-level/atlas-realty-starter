...
const rubricPages: Record<JournalCategoryKey, RubricPageConfig> = {
  kvartiry: { h1: "Статьи о недвижимости", lead: "Разбираем покупку, продажу, проверку документов и выбор квартиры в вашем городе спокойным практическим языком.", topics: ["buying", "selling", "doma"], offerTitle: "Квартиры, которые можно разобрать со специалистом", offerHref: "/kvartiry", offerLabel: "Открыть квартиры", catalogKind: "listings", listingCategory: "flat" },

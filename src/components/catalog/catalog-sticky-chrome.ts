...
export const OPEN_CATALOG_FILTERS_EVENT = "agency:open-catalog-filters";
export const OPEN_CATALOG_FILTERS_STORAGE_KEY = "agency:open-catalog-filters";
export const ALL_REALTY_CATALOG_PATH = "/nedvizhimost";

const SHOWCASE_PATHS = new Set(catalogPresetPaths);
const SESSION_STICKY_PATHS = new Set(["/izbrannoe", "/sravnenie"]);
...
/** Compact floating mobile bar on scroll (catalog or favorites/sravnenie). */

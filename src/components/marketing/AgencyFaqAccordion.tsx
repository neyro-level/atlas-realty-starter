      ...
      {items.map((item, index) => {
        ...
        return (
          ...
          >
            ...
            >
              <span className="col-span-2 font-mono text-[11px] font-semibold leading-5 tracking-[0.12em] text-[var(--agency-faq-accordion-content-primary)] tabular-nums sm:col-span-1">
            ...
            >
              <div className="overflow-hidden">
                <div className="max-w-[760px] space-y-4 px-4 pb-7 pt-0 text-[14px] leading-7 text-[var(--agency-faq-accordion-content-secondary)] sm:pl-[92px] sm:pr-16 md:pb-8 md:text-[15px] md:leading-7">

...
export function CorporateLandingPage({ page, visitorQuery, showcaseLimit, showcaseQuery, showcase, relatedArticles }: CorporateLandingPageProps) {
  ...
  return (
    <CorporateLandingView
      ...
      catalogHero={<CatalogHeroBlock title={page.heroTitle} titleLines={page.heroTitleLines} titleSize={page.heroTitleSize} description={usesPageHeroDescription ? page.heroDescription : undefined} descriptionVisibility={showsHeroContentOnMobile ? "always" : undefined} imageSrc={page.heroImage?.src} imagePosition={page.heroImage?.position} expandedDesktop={page.heroExpandedDesktop} focusImageBottomDesktop={page.heroFocusImageBottomDesktop} actionVisibility={showsHeroContentOnMobile ? "always" : undefined} action={<CorporatePrimaryCta page={page} className="inline-flex min-h-12 w-full max-w-full shrink-0 items-center justify-center rounded-lg bg-[#8A1515] px-4 text-sm font-semibold whitespace-nowrap text-white transition hover:bg-[#630E0E] sm:w-auto sm:min-w-[252px] sm:px-6" showIcon={false} />} />}
      primaryAction={<CorporatePrimaryCta page={page} className="inline-flex min-h-12 items-center justify-center gap-2 rounded-lg bg-[#8A1515] px-5 text-sm font-bold text-white transition hover:bg-[#630E0E] sm:w-fit" />}
      bodyBeforeRelated={<>
        ...
        {page.slug === "rabota-rieltorom" ? <><CareersWorkSystemView content={careersWorkSystem} /><CareersComparisonView content={careersComparison} /><CareersTrainingView content={careersTraining} imageRenderer={CorporateImage} /><CareersFinalCtaView content={careersFinalCta} quizButton={<CareersQuizButton source="corporate:rabota-rieltorom:final" className="inline-flex min-h-12 w-full items-center justify-center rounded-lg bg-[#8A1515] px-6 text-sm font-semibold text-white transition hover:bg-[#630E0E] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#8A1515] sm:w-auto sm:min-w-[260px]" />} /><CareersQuizModal /></> : null}
      </>}

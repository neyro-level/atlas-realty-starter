...
export const journalCategories: JournalCategoryConfig[] = [
  {
    slug: "kvartiry",
    title: "Квартиры",
    seoTitle: "Журнал агентства: квартиры и безопасная покупка в вашем городе",
    seoDescription:
      "Материалы агентства недвижимости о проверке квартиры, документах и безопасной покупке жилья в вашем городе.",
  ...
  },
  {
    slug: "ipoteka",
    title: "Ипотека",
    seoTitle: "Журнал агентства: ипотека в вашем городе и выбор программы",
    seoDescription:
      "Практические материалы агентства недвижимости о выборе ипотечной программы, объекта и маршрута одобрения в вашем городе.",
  ...
  },
  {
    slug: "novostroyki",
    title: "Новостройки",
    seoTitle: "Журнал агентства: новостройки вашего города, ЖК и ипотечный сценарий",
    seoDescription:
      "Материалы агентства недвижимости о выборе новостройки, квартиры в ЖК и ипотечном маршруте для новостроек вашего города.",

    ...
    <div className="mt-12 sm:mt-14">
      ...
      >
        {examples.map((project) => (
          <article
            key={project.id}
            className="group flex min-w-0 flex-col overflow-hidden rounded-sm border border-[var(--border)] bg-white shadow-[var(--leadgen-construction-project-showcase-shadow-primary)] transition duration-300 hover:-translate-y-0.5 hover:border-[var(--leadgen-construction-project-showcase-border-primary)] hover:shadow-[var(--leadgen-construction-project-showcase-shadow-secondary)] max-md:w-[82vw] max-md:max-w-90 max-md:shrink-0 max-md:snap-start"
          >

...
export const homeNewBuildingQuizContent = {
  ...
  route: "/",
  title: "Подбор новостроек в Краснодаре",
  description:
    "Подберите новостройку в Краснодаре на главной странице агентства недвижимости: бюджет, сроки и способ оплаты.",
  manager: {
  ...
  quiz: {
    title: "Подбор новостроек в Краснодаре",
    expertText:
      "Ответьте на 4 коротких вопроса. Я подберу подходящие новостройки в Краснодаре и помогу с ипотекой и проверкой документов.",
    expertNote:
    ...
    messageIntro: "Клиент просит подбор новостроек в Краснодаре.",
    errors: {

...
const variants = {
  primary: "bg-[var(--palette-9e0707)] text-white hover:bg-[var(--palette-7a0505)]",
  secondary: "border border-[var(--palette-d8d1cb)] bg-white text-[var(--palette-141414)] hover:border-[var(--palette-9e0707)] hover:text-[var(--palette-9e0707)]",
...
export function RequestCta({
  ...
  return (
    <button
      ...
      className={`inline-flex min-h-12 items-center justify-center gap-2 rounded-lg px-5 text-sm font-bold transition focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--palette-9e0707)] ${variants[variant]} ${className}`}
    >
      {label}

...
export function EmployeeReviewForm({ agentId, fullName }: { agentId: string; fullName: string }) {
  ...
  return (
    <>
      <Button type="button" onClick={show} variant="outline" className="inline-flex min-h-11 rounded-lg border-[var(--employee-review-form-border-primary)] bg-white px-5 text-body font-semibold text-[var(--text-primary)] hover:border-[var(--accent)] hover:text-[var(--accent)]">
        Оставить отзыв
      </Button>

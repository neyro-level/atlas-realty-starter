...
export const corporatePages: CorporatePageConfig[] = [
  {
    ...
    title: "Недвижимость в вашем городе купить - квартиры, дома, участки | АТЛАС",
    description:
      "Недвижимость в вашем городе: квартиры, дома, участки и коммерческие объекты. Подберем варианты, проверим документы, поможем с ипотекой и сделкой.",
    eyebrow: "Недвижимость агентства недвижимости",
    heroTitle: "Недвижимость в вашем городе",
    heroDescription:
    ...
    showcase: {
      heading: "Недвижимость в вашем городе",
      description: "",
  ...
  },
  {
    slug: "kvartiry",
    navLabel: "Квартиры",
    title: "Купить квартиру в вашем городе | АТЛАС",
    description:
      "Квартиры в вашем городе по району, бюджету и комнатности. Покажем актуальные варианты, проверим документы и поможем с ипотекой и сделкой.",
    eyebrow: "Квартиры агентства недвижимости",
    heroTitle: "Квартиры в вашем городе",
    heroDescription:
      "Страница для тех, кто ищет квартиру в вашем городе под жизнь, переезд или инвестицию. Сначала показываем понятный срез предложений, затем помогаем дойти до сделки.",
    ...
    showcase: {
      heading: "Подборка квартир в вашем городе",
  ...
  },
  {
    slug: "doma",
    navLabel: "Дома",
    title: "Купить дом в вашем городе - дома с документами | АТЛАС",
    description:
      "Продажа домов в вашем городе и регионе. Подбор по району, бюджету, площади и участку. Проверяем документы на дом и землю перед сделкой.",
    eyebrow: "Дома агентства недвижимости",
    heroTitle: "Дома в вашем городе",
    heroDescription:
      "Подбор домов и домовладений в вашем городе с упором на документы, связку дома и земли, состояние объекта и реальный сценарий проживания.",
    ...
    showcase: {
      heading: "Подборка домов в вашем городе",
  ...
  },
  {
    ...
    navLabel: "Участки",
    title: "Купить земельный участок в вашем городе - под строительство | АТЛАС",
    description:
      "Земельные участки в вашем городе и регионе. Подбор участков под строительство, дачу или инвестицию. Поможем проверить документы и ограничения.",
    eyebrow: "Земельные участки",
    heroTitle: "Земельные участки в вашем городе",
    heroDescription:
    ...
    showcase: {
      heading: "Подборка участков в вашем городе",
      description: "Актуальные предложения по земельным участкам в вашем городе и регионе.",
  ...
  },
  {
    ...
    title: "Купить коммерческую недвижимость в вашем городе | АТЛАС",
    description:
      "Коммерческие объекты в вашем городе для бизнеса и инвестиций. Подберём помещение, проверим локацию, назначение, документы и условия сделки.",
    eyebrow: "Коммерческая недвижимость",
    heroTitle: "Коммерческая недвижимость в вашем городе",
    heroDescription:
    ...
    showcase: {
      heading: "Коммерческие объекты в вашем городе",
  ...
  },
  {
    ...
    title: "Новостройки и квартиры в ЖК вашего города | АТЛАС",
    description:
      "ЖК и новостройки вашего города: цены, планировки, сроки сдачи и ипотека по актуальным условиям. Сравним комплексы и поможем выбрать квартиру.",
    eyebrow: "Новостройки агентства недвижимости",
    heroTitle: "ЖК и новостройки в вашем городе",
    heroDescription:
      "Собрали ключевые жилые комплексы вашего города с базовой информацией по срокам, цене, планировкам и ипотечному сценарию.",
    ...
    heroCards: [
      { title: "Жилые комплексы", text: "Показываем ключевые ЖК вашего города в одном понятном контуре." },
  ...
  },
  {
    slug: "ipoteka",
    navLabel: "Ипотека",
    title: "Ипотека в вашем городе — помощь с одобрением | АТЛАС",
    description:
      "Ипотека для квартиры, дома или новостройки в вашем городе. Рассчитаем платёж, подберём программу и банк, проверим объект и документы.",
  ...
  },
  {
    ...
    title: "Продажа недвижимости в вашем городе | АТЛАС",
    description:
      "Поможем продать квартиру, дом, участок или коммерческий объект в вашем городе: подготовим подачу, показы, переговоры и сделку.",
  ...
  },
  {
    ...
    title: "Безопасная сделка - юридическая проверка недвижимости в вашем городе",
    description:
  ...
  },
  {
    ...
    title: "Юрист по недвижимости в вашем городе | АТЛАС",
    description:
      "Юрист по недвижимости в вашем городе: проверка документов, наследство, регистрация права, земельные вопросы, споры и сопровождение сделки.",
    eyebrow: "Юридическая помощь",
    heroTitle: "Юрист по недвижимости в вашем городе",
    heroDescription:
  ...
  },
  {
    slug: "otzyvy",
    navLabel: "Отзывы",
    title: "Отзывы об агентстве недвижимости «АТЛАС» в вашем городе",
    description:
      "Отзывы клиентов агентства недвижимости в вашем городе: покупка и продажа недвижимости, ипотека, новостройки, сопровождение сделки и работа специалистов.",
  ...
  },
  {
    slug: "kontakty",
    navLabel: "Контакты",
    title: "Контакты агентства недвижимости в вашем городе",
    description:
  ...
  },
  {
    ...
    description:
      "АТЛАС — агентство недвижимости в вашем городе: покупка, продажа, новостройки, ипотека и юридическое сопровождение сделки.",
    eyebrow: "О нас",
    heroTitle: "АТЛАС — агентство недвижимости в вашем городе",
    heroDescription:
    ...
    heroCards: [
      { title: "Локальный контур", text: "Работаем с недвижимостью вашего города и ведём клиента через понятные офисы и каналы связи." },
  ...
  },
  {
    ...
    navLabel: "Вакансии",
    title: "Вакансии в агентстве недвижимости «АТЛАС» в вашем городе",
    description:
      "Вакансии в агентстве недвижимости «АТЛАС» в вашем городе. Обучение, адаптация, стандарты работы, наставничество и развитие.",
  ...
  },
  {
    ...
    title: "Строительство домов в вашем городе | АТЛАС",
    description:
      "Строительство домов в вашем городе под ключ и под льготную ипотеку. Поможем разобраться с участком, проектом, подрядчиком и документами.",
    eyebrow: "Строительство домов",
    heroTitle: "Постройте собственный дом в вашем городе",
    heroDescription:
  ...
  },
  {
    ...
    navLabel: "Вторичка",
    title: "Вторичка в вашем городе - купить квартиру на вторичном рынке | АТЛАС",
    description:
      "Квартиры на вторичном рынке вашего города. Подбор вариантов по бюджету, району и документам. Поможем проверить объект перед покупкой.",
    eyebrow: "Вторичный рынок",
    heroTitle: "Вторичка в вашем городе",
    heroDescription:
  ...
  },
  {
    slug: "rieltor",
    navLabel: "Риэлтор",
    title: "Риэлтор в вашем городе для покупки и продажи недвижимости | АТЛАС",
    description:
      "Риэлтор в вашем городе для покупки и продажи недвижимости. Подберем специалиста под квартиру, дом, участок, новостройку или сделку.",
    eyebrow: "Эксперт агентства недвижимости",
    heroTitle: "Риэлтор в вашем городе",
    heroDescription:
      "Коммерческая страница под запрос риэлтора в вашем городе: объясняем, в каких сценариях нужен специалист и как строится маршрут сделки через «АТЛАС».",
    primaryCta: { label: "Разобрать мою ситуацию", href: "/kontakty" },

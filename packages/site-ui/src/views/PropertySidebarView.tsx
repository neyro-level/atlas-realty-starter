    ...
    <form className="grid gap-4" onSubmit={onSubmit} data-analytics-form-type="property_chat" noValidate>
      <div className="grid gap-2 pt-1.5">
        ...
        <div className="relative">
          <Input unstyled
            ...
            className="min-h-10 w-full rounded-lg border border-[var(--border)] bg-white px-3 pr-9 text-xs font-medium text-[var(--text-primary)] outline-none transition placeholder:text-[var(--text-muted)] focus:border-[var(--accent)]"
          />
      ...
      <div className="grid gap-2">
        ...
        <Input unstyled
          ...
          maxLength={18}
          className="min-h-10 rounded-lg border border-[var(--border)] bg-white px-3 text-xs font-medium text-[var(--text-primary)] outline-none transition placeholder:text-[var(--text-muted)] focus:border-[var(--accent)]"
        />
      </div>

  ...
  return (
    <section id={sectionId} className={headline ? "bg-white pb-10 pt-6 lg:pb-14 lg:pt-8" : "bg-white pt-4 pb-10 md:pt-5 lg:py-14"} aria-label={heading || "Каталог недвижимости"}>
      <div className="mx-auto max-w-site-frame px-5">
        {headline ? <div className="mb-7 rounded-lg border border-[#E9E9E6] bg-[var(--surface-card-soft)] px-5 py-5 md:px-6 md:py-6"><h1 className="max-w-[920px] text-[20px] font-extrabold leading-[1.18] text-[var(--text-primary)] md:text-[24px] lg:text-[26px]">{headline}</h1></div> : null}

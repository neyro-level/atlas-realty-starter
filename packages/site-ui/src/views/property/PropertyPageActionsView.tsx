...
export function PropertyPageActionsView({
  ...
  return (
    <div className="grid gap-4">
      ...
      <Button variant="plain" type="button" onClick={onOpenChat} className="inline-flex min-h-12 w-full items-center justify-center gap-2 rounded-md border border-[var(--border)] bg-[var(--surface-card)] px-5 text-sm font-bold text-[var(--text-primary)] transition hover:border-[var(--accent)] hover:text-[var(--accent)]">

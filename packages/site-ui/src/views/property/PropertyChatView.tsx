            ...
            <label className="grid gap-2.5 text-support font-semibold text-[var(--text-primary)]">
              ...
              <div className="relative">
                <Textarea variant="plain"
                  ...
                  rows={4}
                  className="min-h-32 w-full rounded-md border border-[var(--border)] bg-[var(--surface-card)] px-3 py-3 text-support font-normal leading-6 outline-none transition focus:border-[var(--accent)]"

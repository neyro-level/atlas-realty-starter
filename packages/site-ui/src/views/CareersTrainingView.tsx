    ...
    >
      <div className="mx-auto max-w-site-frame px-5">
        ...
        <div className="mt-9 grid gap-6 lg:mt-12 lg:grid-cols-[minmax(360px,0.92fr)_minmax(0,1.08fr)] lg:items-stretch lg:gap-8">
          <div className="relative aspect-[4/3] overflow-hidden rounded-2xl bg-[var(--careers-training-surface-01)] lg:aspect-auto lg:min-h-[470px]">
            <ImageRenderer
          ...
          <div className="flex flex-col rounded-2xl bg-[var(--careers-training-surface-02)] p-5 sm:p-7 lg:p-9">
            ...
            <div className="mt-8 border-t border-[var(--careers-training-border-01)] pt-7">
            ...
            <div className="mt-auto pt-8">
              <div className="rounded-xl bg-[var(--careers-training-surface-03)] px-5 py-5 text-white sm:px-6">
        ...
        <div className="mt-10 border-t border-[var(--border)] pt-7 sm:mt-12 sm:pt-8">
          ...
          <ol className="mt-5 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
            {careersTraining.steps.map((step, index) => (
              <li
                key={step.title}
                className="flex min-h-[190px] flex-col rounded-xl bg-[var(--careers-training-surface-04)] p-5"
              >

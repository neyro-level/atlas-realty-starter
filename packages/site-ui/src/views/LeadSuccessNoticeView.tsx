    ...
    >
      ...
      >
        <button
          ...
          className="absolute right-4 top-4 grid size-9 place-items-center rounded-lg text-[#777375] transition hover:bg-[#F4F3F1] hover:text-[var(--text-primary)]"
        >
        ...
        <p className="mx-auto mt-3 max-w-[320px] text-sm leading-6 text-[#5F5B5D]">

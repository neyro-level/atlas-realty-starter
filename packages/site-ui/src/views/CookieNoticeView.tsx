...
export function CookieNoticeView({ onAccept, linkRenderer: LinkRenderer }: CookieNoticeViewProps) {
  return (
    <Card
      className="fixed bottom-3 left-1/2 z-[9999] w-[calc(100%-1.5rem)] -translate-x-1/2 rounded-md border border-[var(--cookie-notice-border-primary)] bg-white p-3 shadow-[var(--cookie-notice-shadow-primary)] sm:bottom-4 sm:w-[calc(100%-2rem)] sm:px-5 sm:py-3 lg:w-[70%] lg:max-w-217"
      role="region"

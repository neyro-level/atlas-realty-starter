...
export function MortgageConsultationView({ form, title, subtitle }: { form: ReactNode; title: ReactNode; subtitle: string }) {
  return <section className="bg-[var(--surface-card)] pb-16 pt-0 sm:pb-20 lg:pb-24" aria-labelledby="mortgage-consultation-title">
    <div className="mx-auto max-w-site-frame px-5"><div className="border-t border-[var(--border)] px-0 pb-1 pt-9 sm:pt-11 lg:pt-12">
      <div className="mx-auto max-w-210 text-center"><h2 id="mortgage-consultation-title" className="text-section-title font-semibold leading-section-title text-[var(--text-primary)]">{title}</h2><p className="mt-3 text-body leading-body text-[var(--corporate-form-section-views-content-tertiary)] sm:text-body-compact">{subtitle}</p></div>

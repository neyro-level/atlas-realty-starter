...
export function CareersComparisonView({ content: careersComparison }: { content: CareersComparisonContent }) {
  return (
    <section
      className="bg-[var(--careers-comparison-surface-primary)] py-12 sm:py-16 lg:py-22"
      ...
      <div className="mx-auto max-w-site-frame px-5">
        ...
        <div className="mt-9 grid gap-4 lg:mt-12 lg:grid-cols-[minmax(0,1fr)_64px_minmax(0,1fr)] lg:items-stretch lg:gap-5">
          ...
          <div className="flex min-h-12 items-center justify-center" aria-hidden>
            <span className="hidden size-12 items-center justify-center rounded-full border border-[var(--careers-comparison-border-primary)] bg-[var(--surface-card)] text-label font-semibold uppercase text-[var(--text-muted)] lg:flex">
              vs
            </span>
            <span className="flex size-10 items-center justify-center rounded-full bg-[var(--surface-card)] text-[var(--accent)] shadow-[var(--careers-comparison-shadow-primary)] lg:hidden">
          ...
          >
            <span
              className={`mt-0.5 flex size-[22px] items-center justify-center rounded-full ${
                isBrand
                  ? 'bg-[var(--surface-card)]/12 text-white'

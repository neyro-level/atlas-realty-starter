...
export function EmployeeCardView({
  ...
  return (
    <article className="group flex h-full flex-col overflow-hidden rounded-lg border border-[var(--employee-card-border-primary)] bg-white transition duration-300 hover:-translate-y-0.5 hover:border-[var(--employee-card-border-secondary)] hover:shadow-[var(--employee-card-shadow-primary)]">

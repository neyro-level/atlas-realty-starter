    ...
    <main className="bg-white font-sans text-[var(--text-primary)]">
      ...
      >
        ...
        >
          <div className="mx-auto w-full max-w-[1120px] text-center">
            <p className="relative inline-flex max-w-full overflow-hidden rounded-[10px] border border-white/14 bg-white/[0.07] px-3.5 py-2.5 text-[13px] font-semibold text-white/92 shadow-[var(--leadgen-promo-landing-shadow-secondary)] backdrop-blur-lg min-[380px]:text-sm sm:px-4 sm:text-[15px]">
        ...
        {content.hero.badge ? (
          <div className="pointer-events-none absolute bottom-8 right-5 hidden rounded-[9px] border border-white/16 bg-white/12 px-4 py-3 text-left text-[12px] font-semibold leading-tight text-white/88 shadow-[var(--leadgen-promo-landing-shadow-subtle)] backdrop-blur-md sm:right-8 lg:block">
            {content.hero.badge}
          </div>
        ) : null}
      </section>
        ...
        <section className="pointer-events-none relative z-20 mx-auto -mt-32 w-full max-w-[1220px] px-5 pb-14 pt-10 sm:-mt-44 sm:px-8 sm:pb-16 sm:pt-14 lg:-mt-52 lg:pt-16">
          ...
          <div className="pointer-events-auto mt-7 grid gap-3 sm:mt-8 sm:gap-4 lg:grid-cols-3">
            {content.trustItems.map((item, index) => (
              <article
                key={item.title}
                className="group relative overflow-hidden rounded-[8px] border border-[var(--leadgen-promo-landing-border-primary)] bg-white p-4 shadow-[var(--leadgen-promo-landing-shadow-muted)] transition hover:-translate-y-1 hover:border-[var(--leadgen-promo-landing-border-secondary)] hover:shadow-[var(--leadgen-promo-landing-shadow-strong)] sm:min-h-[214px] sm:p-6 sm:shadow-[var(--leadgen-promo-landing-shadow-inverse)]"
              >
                <div className="absolute inset-x-0 top-0 h-[3px] bg-[var(--accent)]" aria-hidden />
                <div className="absolute right-4 top-4 text-[11px] font-bold tracking-[0.18em] text-[var(--leadgen-promo-landing-content-primary)]" aria-hidden>
                  {String(index + 1).padStart(2, "0")}
                </div>
                <div className="flex items-start justify-between gap-4 pr-10">
                  <span className="grid size-10 shrink-0 place-items-center rounded-[7px] border border-[var(--leadgen-promo-landing-border-primary)] bg-[var(--leadgen-promo-landing-surface-secondary)] text-[var(--accent)] shadow-[var(--leadgen-promo-landing-shadow-hover)] sm:size-12">
                ...
                <p className="mt-2 text-[13px] font-medium leading-5 text-[var(--leadgen-promo-landing-content-secondary)] sm:mt-3 sm:text-sm sm:leading-6">{item.text}</p>
              </article>
            ))}
          </div>
        </section>
      ...
      {compact || content.hideBaseSection ? null : (
        ...
        >
          <div className={content.baseSection.preview ? "max-w-[690px]" : "max-w-[460px] lg:sticky lg:top-28"}>
            ...
            <p className={`${content.baseSection.preview ? "mt-8 font-semibold text-[var(--text-primary)]" : "mt-5 text-[var(--leadgen-promo-landing-content-tertiary)]"} text-[17px] leading-7`}>
              {content.baseSection.subtitle}
            </p>
            {content.baseSection.badge ? (
              <p className="mt-6 flex w-full items-center gap-3 rounded-[8px] bg-[var(--accent)] px-4 py-3 text-[13px] font-semibold leading-5 text-white shadow-[var(--leadgen-promo-landing-shadow-active)] sm:inline-flex sm:w-auto sm:px-5 sm:text-sm">
                ...
                {content.baseSection.points.map((point, index) => {
                  ...
                  return (
                    <div
                      ...
                      className="group relative overflow-hidden rounded-[8px] border border-[var(--leadgen-promo-landing-border-tertiary)] bg-white p-4 shadow-[var(--leadgen-promo-landing-shadow-selected)]"
                    >
                      <div className="mb-4 flex items-center justify-between gap-3">
                        <span className="grid size-8 place-items-center rounded-[6px] bg-[var(--accent-soft)] text-[var(--accent)]">
                          <Check className="size-4" aria-hidden />
                        </span>
                        <span className="text-[11px] font-bold text-[var(--leadgen-promo-landing-content-subtle)]">
                          {String(index + 1).padStart(2, "0")}
                        </span>
                      </div>
                      {item.title ? <h3 className="text-sm font-semibold leading-5 text-[var(--text-primary)]">{item.title}</h3> : null}
                      <p className={`${item.title ? "mt-2" : ""} text-[13px] font-medium leading-6 text-[var(--leadgen-promo-landing-content-muted)]`}>{item.text}</p>
          ...
          {content.baseSection.preview ? (
            ...
            <div className="overflow-hidden rounded-[8px] border border-[var(--leadgen-promo-landing-border-subtle)] bg-[var(--leadgen-promo-landing-surface-tertiary)] px-5 sm:px-7 lg:px-8">
              {content.baseSection.points.map((point, index) => {
                const item = normalizeBaseSectionPoint(point);
                ...
                return (
                  ...
                  >
                    ...
                    <span className="hidden size-11 place-items-center rounded-[7px] border border-[var(--leadgen-promo-landing-border-strong)] bg-white text-[var(--accent)] sm:grid">
                    ...
                    <div>
                      {item.title ? <h3 className="text-[15px] font-semibold leading-6 text-[var(--leadgen-promo-landing-content-strong)] sm:text-base">{item.title}</h3> : null}
                      <p className={`${item.title ? "mt-1.5" : "font-semibold"} text-[14px] leading-6 text-[var(--leadgen-promo-landing-content-inverse)] sm:text-[15px]`}>{item.text}</p>
                    </div>
                  </article>
                );
              })}
      ...
      {compact || content.hideBonusSection ? null : (
        <section className="mx-auto w-full max-w-[1160px] px-5 pb-14 sm:px-8 sm:pb-16">
          <div className="relative overflow-hidden rounded-[8px] border border-[var(--leadgen-promo-landing-border-primary)] bg-[var(--leadgen-promo-landing-surface-subtle)] p-4 shadow-[var(--leadgen-promo-landing-shadow-disabled)] sm:p-6 lg:p-7">
                ...
                <div className="mt-5 grid gap-3 md:grid-cols-2">
                  {content.bonusItems.map((item, index) => {
                    ...
                    return (
                      <div
                        key={item}
                        className="grid min-h-[132px] grid-cols-[38px_minmax(0,1fr)] gap-4 rounded-[8px] border border-[var(--leadgen-promo-landing-border-subtle)] bg-white p-4 shadow-[var(--leadgen-promo-landing-shadow-overlay)]"
                      >
                        <span className="grid size-9 place-items-center rounded-[6px] bg-[var(--accent-soft)] text-[var(--accent)]">
                          <Icon className="size-[18px]" aria-hidden />
                        </span>
                        <p className="text-[13px] font-medium leading-6 text-[var(--leadgen-promo-landing-content-hover)]">{item}</p>
                      </div>
                    );
                  })}
                </div>

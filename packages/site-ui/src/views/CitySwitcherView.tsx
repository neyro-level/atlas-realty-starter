  ...
  return (
    <div className="relative">
      ...
      <div
        ...
        role="menu"
        aria-labelledby={triggerId}
        className={`absolute left-0 top-[calc(100%+8px)] z-50 w-[248px] rounded-[12px] border border-[var(--border)] bg-white p-1.5 shadow-[0_22px_64px_rgba(0,0,0,0.14)] transition duration-150 ${

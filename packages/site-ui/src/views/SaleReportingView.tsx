        ...
        <div className="grid overflow-hidden rounded-xl border border-[var(--border)] bg-white md:grid-cols-[minmax(0,3fr)_minmax(280px,2fr)]">
          <div className="flex flex-col justify-center p-6 sm:p-8 lg:p-12">
            <h2
              ...
              className="max-w-190 text-section-small font-semibold leading-[1.24] tracking-[-0.03em] text-[var(--text-primary)] text-balance sm:text-[length:var(--site-type-section)] sm:leading-[1.2]"
            >
          ...
          <div className="flex min-h-60 items-center justify-center border-t border-[var(--border)] bg-[var(--accent-soft)] p-8 md:min-h-85 md:border-t-0 md:border-l">
            <div
              className="flex h-47.5 w-40 items-center justify-center rounded-xl border border-[var(--input)] bg-white text-[var(--accent)] shadow-[var(--sale-reporting-shadow-primary)]"
              aria-hidden="true"
            >

...
import type { SiteCityOptionViewDto, SiteMobileMenuActionDto, SiteNavLinkDto } from "../site-shell/site-header.types";
...
function MobileLinkGroup({
  ...
  return (
    <nav aria-label="Типы недвижимости" className="overflow-hidden rounded-emphasis border border-[var(--mobile-menu-border-secondary)] bg-[var(--surface-card)]">
...
function MobileActionGroup({
  ...
  return (
    <nav aria-label="Сервисы и разделы" className="overflow-hidden rounded-emphasis border border-[var(--mobile-menu-border-secondary)] bg-[var(--surface-card)]">

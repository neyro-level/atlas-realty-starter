  ...
  return (
    <Dialog open onOpenChange={(open) => { if (!open) onClose(); }}>
      <DialogContent
        ...
        className="z-[121] grid max-h-[88dvh] w-[min(calc(100vw-32px),860px)] max-w-215 grid-rows-[auto_minmax(0,1fr)] gap-0 overflow-hidden rounded-sm border border-[var(--border)] bg-white p-0 text-left shadow-[var(--shadow-dialog)]"
      ...
      >
        <div className="border-b border-[var(--border)] px-5 py-4 pr-14 text-left sm:px-7 sm:py-5">
          ...
          <Button
            ...
            type="button"
            autoFocus
            className="absolute right-4 top-4 grid place-items-center rounded-compact border border-[var(--border)] bg-white text-[var(--text-primary)] transition hover:border-[var(--accent)] hover:text-[var(--accent)]"
